...
<html>
    ...
    <body>
        <div class="box"><h3>Jeu 5x5 <a href="index.php"> (Retour)</a></h3></div>
        <input type=hidden id=a value=5 />
        ...
        <div id="main">
            <table>
                <tr>
                <div class="line">
                    <td>  <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 />  </td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /></td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /></td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /></td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /></td>
                ...
                <div class="line">
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /> </td>
                    <td> <img class="miniature" src="Images\Rond_morpion.png" title="rond" alt="case occupée" width=90 height=90 /> </td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /> </td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /></td>
                    <td> <img class="miniature" src="Images\croix_morpion.jpg" title="croix" alt="case occupée" width=90 height=90 /></td>
                </div>
